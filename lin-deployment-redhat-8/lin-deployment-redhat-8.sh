...
#==============================================================================
# Script Name: lin-deployment-redhat-8.sh
# Version: v1.0
...
# unzip lin-deployment-redhat-8.zip
...
options=("1: New full deployment" "2: Subscribe server" "3: Install Security tools" "4: Secure Boot Check" "5: Add users" "6: Quit")
