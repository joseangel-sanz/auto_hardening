...
PROXY_ADDR_PORT='10.0.11.1:9400'
...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=52321 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -y relay_proxy://$PROXY_ADDR_PORT/
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:B2454C45-99D3-5AEF-B6D6-F665429AFD66" "token:269F4B98-D19A-867E-7470-955FD769863F" "policyid:6727"
# /opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:B2454C45-99D3-5AEF-B6D6-F665429AFD66" "token:269F4B98-D19A-867E-7470-955FD769863F" "policyid:801"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:B2454C45-99D3-5AEF-B6D6-F665429AFD66" "token:269F4B98-D19A-867E-7470-955FD769863F" "policyid:801"
