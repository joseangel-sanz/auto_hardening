...
# We will add all the NTP servers we know of, and chrony will use whichever is reachable and the best one
# These two are internet based NTP servers
 
# This is a MaerskNet NTP server

server 10.255.127.1
server 10.255.127.12
